    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": DRA_benign().format(general_question=q)}
            ],
            temperature=0.7,
            max_tokens=4000,
...
def generate_batch_data(num_entries=300, batch_size=10, delay_seconds=1):
    ...
    save_data(all_data, "DRA_general_query_imitation_data_300.json")
...
if __name__ == "__main__":
    print("开始批量生成演示（500条）...")
    full_data = generate_batch_data(num_entries=300, batch_size=4, delay_seconds=1)