...
from ..paths import DATA_SRC_DIR, DRA_PROCESSED_DIR, PROJECT_ROOT

def count_files():
    files = [
        str(DRA_PROCESSED_DIR / "GPT_ReLLM(code)310_filtered_attack_with_reflections.jsonl"),
        str(DRA_PROCESSED_DIR / "GPT_ReLLM(paragraph)470_filtered_attack_with_reflections.jsonl"),
        str(DRA_PROCESSED_DIR / "GPT_ReLLM(table)440_filtered_attack_with_reflections.jsonl"),
        str(DATA_SRC_DIR / "DRA_safe_imitation_data_1k_complete.json"),
        str(DATA_SRC_DIR / "DrAttack_safe_imitation_data_500_complete.json"),
        str(DATA_SRC_DIR / "DrAttack(benign)_safe_imitation_data_300_complete.json"),
        str(DATA_SRC_DIR / "DRA(benign)_safe_imitation_data_200_complete.json"),
    ]
...
if __name__ == "__main__":
    ...
    output_dir = str(DATA_SRC_DIR / "general_data_from_alpaca")
