...
# --- 配置项 ---
<<<<<<< HEAD:data_src/generate_reflection_benign_data.py
INPUT_PATH = Path("/DRA/results/attack/batch_llama2_13b_0_120_result.json")
OUTPUT_DIR = Path("/results/DRA_processed")
=======
INPUT_PATH = PROJECT_ROOT / "DRA" / "results" / "attack" / "batch_llama2_13b_0_120_result.json"
OUTPUT_DIR = DRA_PROCESSED_DIR
>>>>>>> bed9ec8 (update):src/self_reflection_llm/data_src/generate_reflection_benign_data.py
